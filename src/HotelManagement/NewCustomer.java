...
public class NewCustomer extends JFrame {
	...
	public NewCustomer() throws SQLException {
	    ...
	    ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("HotelManagement/icons/Customer.jpeg"));
...
//		contentPane.add(lblCountry);
		...
		lblDeposite.setBounds(35, 317, 200, 14);
		contentPane.add(lblDeposite);

		t3 = new JTextField();
		t3.setBounds(271, 274, 150, 20);
		contentPane.add(t3);
		t3.setColumns(10);
...
//	    			String s7 =  t5.getText();
                                ...
                                String q1 = "insert into customer values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s8+"')";
