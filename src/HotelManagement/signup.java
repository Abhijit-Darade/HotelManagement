	...
	btnNewButton.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				if((textField.getText().trim().isEmpty()==true)|| (textField_1.getText().trim().isEmpty()==true)||(textField_2.getText().trim().isEmpty()==true)||( passwordField.getText().toString().trim().isEmpty()==true)){
					...
					if(vp.Check( textField_2.getText().trim())==true) {
						 st.executeUpdate();
							JOptionPane.showMessageDialog(null,"record saved successfully");
					}
					if(vp.Check( textField_2.getText().trim())==false) {
