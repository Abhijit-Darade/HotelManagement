...
PreparedStatement pst = null;
	...
	UpdateRoom() throws SQLException {
		...
		ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("HotelManagement/icons/seventh.jpg"));
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				conn c = new conn();
                                ResultSet rs1 = c.s.executeQuery("select * from customer where number1 = "+s1);
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) throws NumberFormatException {
				...
				try{
                                    conn c = new conn();
                                    String str = "update room set status = '"+txt_Status.getText()+"' where room_number = "+txt_Room.getText();
